...
- A prompt-first shaping skill commits the spec seed locally, linked to the issue its caller names, opens Git-derived focus through a public review link, and keeps the same authoring turn parked through hand-off batches.
