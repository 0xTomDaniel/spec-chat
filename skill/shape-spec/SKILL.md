...
- Accepted spec changes are committed locally before refreshed Git focus or review replies. Push, or open a pull request, only when target instructions or the developer explicitly authorize it.
