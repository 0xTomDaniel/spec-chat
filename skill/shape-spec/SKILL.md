...
3. Deepen only from relevant code, tests, configuration, and change-request state. Resolve discoverable questions before asking the human. Keep the spec always-most-recent and remove stale prose or resolved TBDs.
