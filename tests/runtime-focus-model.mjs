...
assert.match(runtime, /:where\(body\.hx-focus-active \[data-hx-focus=unchanged\]\)\{color:#6b6e75\}/, 'unchanged light-mode text uses one accessible fixed target color');
...
assert.match(runtime, /:where\(body\.hx-focus-active \[data-hx-focus=unchanged\]\)\{color:#9fa1a7\}/, 'unchanged dark-mode text uses one accessible fixed target color');
